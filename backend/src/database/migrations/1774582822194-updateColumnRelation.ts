...
export class UpdateColumnRelation1774582822194 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_roles" ADD CONSTRAINT "FK_87b8888186ca9769c960e926870" FOREIGN KEY ("user_id") REFERENCES "master_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
