...
export class UpdateRelationTableRole1775525303442 implements MigrationInterface {
  name = 'UpdateRelationTableRole1775525303442';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "master_roles" DROP COLUMN "tenant_id"`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "master_roles" ADD "tenant_id" uuid NOT NULL`,
    );
    await queryRunner.query(
